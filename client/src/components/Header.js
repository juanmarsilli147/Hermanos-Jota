        ...
        <header>
            ...
            <nav className='nav' id='nav'>
                <ul className='links-nav'>
                    <li className='nav-link' onClick={() => setRoute("index")}>Inicio</li>
                    <li className='nav-link' onClick={() => setRoute("productos")}>Productos</li>
                    <li className='nav-link' onClick={() => setRoute("contacto")}>Contacto</li>
